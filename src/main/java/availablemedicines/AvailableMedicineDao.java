...
public class AvailableMedicineDao {
	public static List<MedicineDetailBean> availableMedicines(){
		List<MedicineDetailBean> result = new ArrayList<>();
		Connection con = DBConnection.createConnection();
		PreparedStatement pdsm = null;
		ResultSet rs = null;
		try {
			pdsm = con.prepareStatement(QueryUtil.AVAILABLE_MEDICINES_QUERY);
